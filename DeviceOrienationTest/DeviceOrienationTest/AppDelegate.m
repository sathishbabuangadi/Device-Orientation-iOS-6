...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //you can either use any of the notifcation to get device orientation
//    [[NSNotificationCenter defaultCenter] addObserver: self selector: @selector(deviceOrientation:) name: UIApplicationWillChangeStatusBarOrientationNotification object: nil];
